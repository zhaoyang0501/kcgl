...
<body >
                    ...
                    <div class="ibox-content">
                        <form role="form" class="form-inline">
                            <div class="form-group">
                                <label for="exampleInputEmail2" class="sr-only">仓库编号</label>
                                <select id='_categoryid' class='form-control'>
                            ...
                            <div class="col-sm-12 b-r">
		                           ...
		                           <input name='id' type="hidden"/>
		                           	<table class='table table-bordered'>
		                           		<thead>
		                           		<tr style="text-align: center;" ><td colspan="6" ><h3>货物管理信息<h3></h3></td></tr>
		                           		</thead>
		                           		<tbody>
   ...
   <script>
    ...
    function submit_form(){
    	$.ajax({
    		   type: "POST",
    		   url:  $.common.getContextPath() + "/sys/good/save",
    		   data: $("form").serialize(),
    ...
    function fun_delete(id){
    	...
    	layer.confirm('确定删除货物？', {
    		  btn: ['确定','取消'] //按钮
    		}, function(){
    			$.ajax({
    		 		   url:  $.common.getContextPath() + "/sys/good/delete?id="+id,
    		 		   success: function(msg){
    		 		     if(msg.code==1){
    		 		    	 toastr.success('操作成功');
    		 		    	 table.draw();
    ...
    function fun_update(id){
    	$.ajax({
 		   url:  $.common.getContextPath() + "/sys/good/get?id="+id,
 		   success: function(msg){
 		     if(msg.code==1){
 		    	$("input[name='id']").val(msg.datas.id);
 		    	$("input[name='good']").val(msg.datas.good);
 		    	$("radio[name='goodno']").val(msg.datas.goodno);
    ...
    $(document).ready(function(){
        	...
        	table=$('#dt_table_view').DataTable( {
	            ...
	            "ajax": {
	                "url":  $.common.getContextPath() + "/sys/good/querybycategory",
	                "type": "POST",
	                "dataSrc": "datas"
	              },
				"columns" : [{
