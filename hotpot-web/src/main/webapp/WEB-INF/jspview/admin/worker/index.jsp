...
<body>
					...
					<div class="span12">
						<div class="content-widgets ">
							...
							<div class="row-fluid ">
									...
									<a class="btn btn-success" style="float: right; margin: 5px;" onclick="$.adminWorker.showWorkerAddModal()"><i class="icon-plus"></i>员工登记</a>
	...
	<div class="modal hide fade" id="_modal">
		...
		<div class="modal-footer center" id="div_footer">
			<a class="btn btn-primary" onclick="$.adminWorker.saveWorker()">保存</a>
