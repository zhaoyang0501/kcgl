                            ...
                            <div class="col-sm-12 b-r">
		                           ...
		                           <input name='id' type="hidden"/>
		                           	<table class='table table-bordered'>
		                           		<thead>
		                           		<tr style="text-align: center;" ><td colspan="6" ><h3>公告发布<h3></h3></td></tr>
		                           		</thead>
		                           		<tbody>
		                           			<tr>
		                           				<td>标题</td>
		                           			...
		                           			<tr>
		                           				<td>作者</td>
		                           				<td> <input name='creter' type="text" class="form-control"></td>
		                           			</tr>
											<tr>
												<td>内容</td>
		                           				<td> <textarea  id='body' name='body' rows="4" cols="" style="width: 80%"></textarea></td>
		                           			</tr>
